...
=======
	nvcc -arch=sm_20 -O -Icommon/inc sgm.cu -Llib -lcutil_x86_64 -o sgm

testDiffs: testDiffs.cu lib/libcutil_x86_64.a
	nvcc -arch=sm_20 -O -Icommon/inc testDiffs.cu -Llib -lcutil_x86_64 -o testDiffs
>>>>>>> e629efa217b9e7636680383dd56d5ce700d78bf1
